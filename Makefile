...
obj_clean: 
	...
	int64_pack.o int64_unpack.o integer-conf integer-conf.o scan_f32.o \
	scan_f64.o scan_fspec.a scan_spec.a scan_u32.o scan_u32o.o 
	rm -f scan_u32x.o scan_u64.o scan_u64o.o scan_u64x.o sysinfo \
	sysinfo.o uint16.a uint16_pack.o uint16_unpack.o uint32.a \
