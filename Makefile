...
clean: obj_clean
obj_clean: 
	rm -f conf-cctype conf-ldtype conf-systype ctxt/bindir.c \
	...
	int64_unpack.o integer-conf integer-conf.o mk-ctxt scan_f32.o \
	scan_f64.o 
	rm -f scan_fspec.a scan_spec.a scan_u32.o scan_u32o.o scan_u32x.o \
	scan_u64.o scan_u64o.o scan_u64x.o sysinfo sysinfo.o uint16.a \
	uint16_pack.o uint16_unpack.o uint32.a uint32_pack.o uint32_unpack.o \
	uint64.a uint64_pack.o uint64_unpack.o 
